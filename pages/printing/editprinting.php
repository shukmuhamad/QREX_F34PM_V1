...
<section class="content">
  <div class="container-fluid">
    ...
    <form id="editprinting" action="../includes/transaction.php?masterID=<?php echo $masterID; ?>" method="post">
      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
          ...
          <div class="card-footer">
            <center>
              <button type="submit" name="editprintingSubmit" class="btn btn-primary">Update</button>
            </center>
          </div>
          <!-- /.card-footer -->
        </div>
