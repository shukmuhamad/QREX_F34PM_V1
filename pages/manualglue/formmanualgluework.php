    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Manual Glue/Work Form</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
...
<section class="content">
  <div class="container-fluid">
    <!-- form start -->
    <form id="manualForm" action="../includes/transaction.php" method="post">
      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
          ...
          <div class="card-footer">
            <center>
              <button type="submit" name="glueSubmit" class="btn btn-primary">Save</button>
            </center>
          </div>
          <!-- /.card-footer -->
        </div>
