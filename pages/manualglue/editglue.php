...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Edit Incoming Manual Work/Glue Form</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item active">Edit Manual Work/Glue Form</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
...
<section class="content">
  <div class="container-fluid">
    ...
    <form id="editglue" action="../includes/transaction.php?masterID=<?php echo $masterID; ?>" method="post">
      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" value="<?php echo date('d/m/Y ', strtotime($record['DateReceived'])); }?>" readonly>
                </div>
                <!-- /.input-group -->
              </div>
              <!-- /.form-group -->
          ...
          <div class="card-footer">
            <center>
              <button type="submit" name="editglueSubmit" class="btn btn-primary">Update</button>
            </center>
          </div>
          <!-- /.card-footer -->
        </div>
