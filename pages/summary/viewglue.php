  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">QA Incoming Manual Glue/Work Form</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
            <li class="breadcrumb-item active">Manual Glue Form</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      ?>
          ...
          <div class="card-footer text-right">
            <a class="btn btn-info" href="manualglue.php?masterID=<?php echo $jobRecord['RecordID'] ?>" target="_blank">
    ...
    <?php
          //Query statements to select from view table
          $query1 = "SELECT * FROM View_GlueInspectRecordByID WHERE RecordID = ?";
    ...
    ?>
            ...
            <div class="info-box bg-light">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <p><?php echo $palletRecord['Position-Sticking Of Promotion Items']; ?></p>
                    </div>
                    <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <p><?php echo $palletRecord['Side Seam Not Glued/Stapled']; ?></p>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label>Material Torn/ Damaged</label>
                  <p><?php echo $palletRecord['Material Torn/Damaged']; ?></p>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label>No String</label>
                  <p><?php echo $palletRecord['No String']; ?></p>
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label>Status</label>
      ...
      <!-- /.card-body -->
      <div class="card-footer text-right">
        <a class="btn btn-info" href="manualInspection.php?masterID=<?php echo $jobRecord['RecordID'] . '&incomingID=' . $palletRecord['IncomingResultID']; ?>" target="_blank">
          <i class="fas fa-pencil-alt">
          </i>
          Edit
        </a>
