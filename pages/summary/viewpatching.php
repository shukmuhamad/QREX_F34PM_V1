...
<body>
 ...
 <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">QA Incoming Window Patching Form</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Patching Form</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
  ...
  <section class="content">
    ...
    ?>
      ...
      <div class="card-footer text-right">
        <a class="btn btn-info" href="patching.php?masterID=<?php echo $jobRecord['RecordID']?>" target="_blank">
    ...
    <?php 
      //Query statements to select from view table
      $query1 = "SELECT * FROM viewPatchInspectRecordByID WHERE RecordID = ?";
        ...
        <div class="info-box bg-light">
          <div class="info-box-content">
            ...
            <div class="col-md-4">
                ...
                <p><?php echo $palletRecord['OPP Out of Position'];?></p>
                </div>
                <div class="form-group">
                <label>Scratch Marks</label>
                <p><?php echo $palletRecord['Scrath Marks'];?></p>
                </div>
                <div class="form-group">
                <label>Material Torn or Damaged</label>
                <p><?php echo $palletRecord['Material Torn or Damaged'];?></p>
                </div>
                <div class="form-group">
                <label>OPP Film Length</label>
                <p><?php echo $palletRecord['OPP Film Length'];?></p>
                </div>
                <!-- /.form-group -->
            ...
            <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <p><?php echo $palletRecord['OPP Film Peel Off'];?></p>
                  </div>
                  <!-- /.form-group -->
                  <div class="form-group">
                    <label>Missing OPP Film</label>
                    <p><?php echo $palletRecord['Missing OPP Film'];?></p>
                  </div>
                  <!-- /.form-group -->
                  <div class="form-group">
 ...
 <!-- /.card-body -->
 <div class="card-footer text-right">
        <a class="btn btn-info" href="patchingInspection.php?masterID=<?php echo $jobRecord['RecordID'].'&incomingID='.$palletRecord['IncomingResultID'];?>" target="_blank">
          <i class="fas fa-pencil-alt">
          </i>
          Edit
        </a>
