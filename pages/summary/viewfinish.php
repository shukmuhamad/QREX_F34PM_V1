    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Finish Form</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
    ...
    ?>
        ...
        <div class="card card-primary">
          ...
          <div class="card-footer text-right">
            <a class="btn btn-info"href="finish.php?masterID=<?php echo $jobRecord['RecordID'] ?>" target="_blank">
        ...
        <?php
        //Query statements to select from view table
        $query1 = "SELECT * FROM View_FinishInspectRecordByID WHERE RecordID = ?";
        ...
        ?>
              ...
              <div class="info-box-content">
                ...
                <div class="info-box bg-light">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <p><?php echo $palletRecord['Position/Registration']; ?></p>
                        </div>
                        <div class="form-group">
                          <label>Finishing Effect</label>
                          <p><?php echo $palletRecord['Finishing Effect']; ?></p>
                        </div>
                        <div class="form-group">
                          <label>Dirty</label>
                        ...
                        <div class="form-group">
                          ...
                          <p><?php echo $palletRecord['Side Lay Stacking']; ?></p>
                        </div>
                        <!-- /.form-group -->
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label>Damages</label>
                      <p><?php echo $palletRecord['Damages']; ?></p>
                    </div>
                    <!-- /.form-group -->
                    <div class="form-group">
          ...
          <!-- /.card-body -->
          <div class="card-footer text-right">
            <a class="btn btn-info" href="finishInspection.php?masterID=<?php echo $jobRecord['RecordID'] . '&incomingID=' . $palletRecord['IncomingResultID']; ?>" target="_blank">
              <i class="fas fa-pencil-alt">
              </i>
              Edit
            </a>
