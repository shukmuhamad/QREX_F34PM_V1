...
<div class="content-header">
     <div class="container-fluid">
       <div class="row mb-2">
         <div class="col-sm-6">
           <h1 class="m-0">QA Incoming Printing Form</h1>
         </div><!-- /.col -->
         <div class="col-sm-6">
           <ol class="breadcrumb float-sm-right">
           <li class="breadcrumb-item"><a href="index.php">Home</a></li>
             <li class="breadcrumb-item active">Printing Form</li>
           </ol>
         </div><!-- /.col -->
       </div><!-- /.row -->
     </div><!-- /.container-fluid -->
 ...
 <section class="content">
   ...
   ?>
     ...
     <div class="card-footer text-right">
       <a class="btn btn-info" href="print.php?masterID=<?php echo $jobRecord['RecordID']?>" target="_blank">
   ...
   <?php 
     //Query statements to select from view table
     $query1 = "SELECT * FROM View_PrintInspectRecordByID WHERE RecordID = ?";
   ...
   <!-- Pallet Details -->
        ...
        <div class="card card-primary">
           <div class="card-header">
             <h3 class="card-title">Print Inspection</h3>
           </div>
           <!-- /.card-header -->
     <div class="card-body">
       ...
       <div class="info-box bg-light">
         <div class="info-box-content">
           ...
           <div class="col-md-4">
               ...
               <p><?php echo $palletRecord['Registration'];?></p>
               </div>
               <div class="form-group">
               <label>Sticking</label>
               <p><?php echo $palletRecord['Sticking'];?></p>
               </div>
               <div class="form-group">
               ...
               <p><?php echo $palletRecord['Spot Varnish'];?></p>
               </div>
               <div class="form-group">
               <label>Incomplete Printing</label>
               <p><?php echo $palletRecord['Incomplete Printing'];?></p>
               </div>
               <div class="form-group">
               <label>Verification of Printed Text</label>
               <p><?php echo $palletRecord['Verification of Printed Text'];?></p>
               </div>
           ...
           <div class="col-md-6">
                 ...
                 <div class="form-group">
                   ...
                   <p><?php echo $palletRecord['Dirt/Ink Smearing'];?></p>
                 </div>
                 <!-- /.form-group -->
                 <div class="form-group">
                   <label>Barcode</label>
                 ...
                 <div class="form-group">
                   ...
                   <p><?php echo $palletRecord['Lot No./Part No'];?></p>
                 </div>
                 <!-- /.form-group -->
                 <div class="form-group">
                   <label>Doubling</label>
                   <p><?php echo $palletRecord['Doubling'];?></p>
                 </div>
                 <!-- /.form-group -->
                 <div class="form-group">
...
<!-- /.card-body -->
<div class="card-footer text-right">
       <a class="btn btn-info" href="printInspection.php?masterID=<?php echo $jobRecord['RecordID'].'&incomingID='.$palletRecord['IncomingResultID'];?>" target="_blank">
         <i class="fas fa-pencil-alt">
         </i>
         Edit
       </a>
