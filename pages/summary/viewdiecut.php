 ...
 <section class="content">
   ...
   ?>
     ...
     <div class="card-footer text-right">
       <a class="btn btn-info" href="diecut.php?masterID=<?php echo $jobRecord['RecordID']?>" target="_blank">
   ...
   <?php 
     //Query statements to select from view table
     $query1 = "SELECT * FROM View_DieInspectRecordByID WHERE RecordID = ?";
       ...
       <div class="info-box bg-light">
         <div class="info-box-content">
           ...
           <div class="col-md-4">
               ...
               <p><?php echo $palletRecord['Score Line'];?></p>
               </div>
               <div class="form-group">
               <label>Window Perforation</label>
               <p><?php echo $palletRecord['Window Perforation'];?></p>
               </div>
               <div class="form-group">
               <label>Die Cut (E-Flute)</label>
               <p><?php echo $palletRecord['Die Cut(E-Flute)'];?></p>
               </div>
           ...
           <div class="col-md-6">
                 <div class="form-group">
                   ...
                   <p><?php echo $palletRecord['Cut Edge'];?></p>
                 </div>
                 <!-- /.form-group -->
                 <div class="form-group">
                   <label>Half Cut</label>
                   <p><?php echo $palletRecord['Half Cut'];?></p>
                 </div>
                 <!-- /.form-group -->
                 <div class="form-group">
                   <label>Cutting Size</label>
                   <p><?php echo $palletRecord['Cutting Size'];?></p>
                 </div>
                 <!-- /.form-group -->
                 <div class="form-group">
                   <label>Paper Facing Up/ Down</label>
                   <p><?php echo $palletRecord['Paper Facing Up/Down'];?></p>
                 </div>
                 <!-- /.form-group -->
                 <div class="form-group" >
                   <label>Status</label>
...
<!-- /.card-body -->
<div class="card-footer text-right">
       <a class="btn btn-info" href="dieInspection.php?masterID=<?php echo $jobRecord['RecordID'].'&incomingID='.$palletRecord['IncomingResultID'];?>" target="_blank">
         <i class="fas fa-pencil-alt">
         </i>
         Edit
       </a>
