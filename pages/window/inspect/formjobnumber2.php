...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Search Window Patching Record Form</h1>
      </div>
      <!-- /.col -->
      <div class="col-sm-6">
...
<section class="content">
  <div class="container-fluid">
    ...
    <!-- Form Start -->
    <form id="patching8Form" action="../includes/transaction.php" method="post">
      ...
      <div class="card card-primary">
        ...
        <div class="card-footer">
          <center>  
            <button type="submit" name="windowpatchingSubmit" class="btn btn-primary">Next</button>
          </center>
        </div>
        <!-- /.card-footer -->
      </div>
