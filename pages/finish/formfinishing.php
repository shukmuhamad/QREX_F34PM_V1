    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Finishing Form</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
...
<section class="content">
  <div class="container-fluid">
    ...
    <!-- form start -->
    <form id="finishingForm" action="../includes/transaction.php" method="post">
      <!-- Type of Finishing -->
        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="form-group">
              <select name="finishingSelect" class="form-control select2" style="width: 100%;" required>
                <option selected="selected" value="">Select Finishing</option>
                <?php
                //Loop every Item row
                foreach ($fetchFinishing as $finish) {
                ?>
                  <option value="<?php echo $finish['FinishingKey']; ?>"><?php echo $finish['FinishingName'];
                                                                      } ?></option>
              </select>
                                                                    </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="jobNumber" class="form-control" id="jobNumber" placeholder="Job Number" onInput="checkJobNumber()" required>
              </div>
              <!-- /.form-group -->
              <div class="form-group">
