...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Search Finishing Record Form</h1>
      </div>
      <!-- /.col -->
      <div class="col-sm-6">
...
<section class="content">
  <div class="container-fluid">
    ...
    <!-- Form Start -->
    <form id="incoming8Form" action="../includes/transaction.php" method="post">
      ...
      <div class="card card-primary">
        ...
        <div class="card-footer">
          <center>  
            <button type="submit" name="incomingSubmit" class="btn btn-primary">Next</button>
          </center>
        </div>
        <!-- /.card-footer -->
      </div>
