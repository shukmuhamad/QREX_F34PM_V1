        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Flute Inspection Form</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <p><?php echo $oirRecord['FluteName'];?></p>
                </div>
                <!-- /.col -->
              </div>
              <!-- /.row -->
 ...
 <!-- Form Start -->
 <form id="fluteInspectForm" action="../includes/transaction.php?masterID=<?php echo $masterID;?>" method="post">
          <!-- Inspection -->
          <div class="card card-primary">
            <div class="card-header">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <label>Size Lot:</label>
                    <input type="text" class="form-control" name="itemNo" id="itemNo" placeholder="Item No" required> 
                  </div>
                  <!-- /.form-group -->
                  <div class="form-group">
                    <label>Sample</label>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text"  name="dieCut" class="form-control defect" placeholder="0" />
                  </div>
                  <!-- /.form-group -->
                  <div class="form-group">
                    <label>Barcode</label>
                    <input type="text"  name="barcode" class="form-control defect" placeholder="0" />
                  </div>
                  <!-- /.form-group -->
  ...
  <!-- /.form-group -->
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Dirty</label>
                    <input type="text"  name="dirty" class="form-control defect" placeholder="0" />
                  </div>
                  <!-- /.form-group -->
                  <div class="form-group">
                    <label>Flute Position Out</label>
                    <input type="text"  name="flutepost" class="form-control defect" placeholder="0" />
                  </div>
                  <!-- /.form-group -->
                  <div class="form-group">
                    <label>Side Seam Not Glued/ Stapled</label>
                    <input type="text"  name="sideGlued" class="form-control defect" placeholder="0" />
                  </div>
                  <!-- /.form-group -->
                  <div class="form-group">
                    <label>Material Torn/ Damage</label>
                    <input type="text"  name="matThorn" class="form-control defect" placeholder="0" />
                  </div>
                  <!-- /.form-group -->
                  <div class="form-group">
                    <label>Poor Cut-Edge</label>
                    <input type="text"  name="poorCut" class="form-control defect" placeholder="0" />
                  </div>
                  <!-- /.form-group -->
     ...
     <!-- Verify Card for Incoming forms -->
		...
		<div class="col-md-6">
          ...
          <div class="card-footer">
            <center>  
            <button type="submit" name="fluteInspectionSubmit"class="btn btn-primary">Save</button>
            </center>
          </div>
          <!-- /.card-footer -->
        </div>
