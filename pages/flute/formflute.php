 ...
 <section class="content">
   <div class="container-fluid">
     ...
     <!-- form start -->
     <form id="fluteForm" action="../includes/transaction.php" method="post">
       <!-- Type of Flute -->
       <div class="card card-primary">
         ...
         <div class="card-body">
           <div class="row">
             <div class="col-md-6">
               <select name="flutetype" class="form-control select2" style="width: 100%;">

                 <option selected="selected">SELECT FLUTE</option>
       ...
       <div class="card card-primary">
         ...
         <div class="card-body">
           ...
           <div class="card-footer">
             <center>
               <button type="submit" name="fluteSubmit" class="btn btn-primary">Save</button>
             </center>
           </div>
           <!-- /.card-footer -->
         </div>
